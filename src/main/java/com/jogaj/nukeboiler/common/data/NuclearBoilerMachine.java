...
public class NuclearBoilerMachine extends WorkableMultiblockMachine implements IExplosionMachine, IDisplayUIMachine {
    protected final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(NuclearBoilerMachine.class, WorkableMultiblockMachine.MANAGED_FIELD_HOLDER);
    ...
    public NuclearBoilerMachine(IMachineBlockEntity holder, int maxTemperature, int heatSpeed, Object... args){
        super(holder, args);
    ...
    public static ModifierFunction recipeModifier(@NotNull MetaMachine machine, @NotNull GTRecipe recipe) {
        if (!(machine instanceof NuclearBoilerMachine nuclearBoilerMachine)) {
            return RecipeModifier.nullWrongType(NuclearBoilerMachine.class, machine);
        }
        if (nuclearBoilerMachine.throttle == 100) return ModifierFunction.IDENTITY;
        return ModifierFunction.builder()
                .durationMultiplier(100.0 / nuclearBoilerMachine.throttle)
                .build();
    }
