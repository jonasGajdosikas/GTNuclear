...
import com.jogaj.nukeboiler.common.data.NukeBoilerBlocks;
...
@GTAddon
public class NukeBoilerGTAddon implements IGTAddon {
    @Override
    public GTRegistrate getRegistrate() {
        return NukeBoiler.REGISTRATE;
    }

    @Override
    public void initializeAddon() {
        NukeBoilerBlocks.init();
    }

    @Override
    public String addonModId() {
        return NukeBoiler.MOD_ID;
    }
